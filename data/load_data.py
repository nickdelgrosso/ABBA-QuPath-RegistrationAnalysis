...
def read_detection_file(filename: str, atlas: BrainGlobeAtlas) -> pd.DataFrame:
    ...
    return (
        df
            ...
            .pipe(lambda df: df.assign(BGIdx=get_brain_region_label(df['Allen CCFv3 X mm'].values, df['Allen CCFv3 Y mm'].values, df['Allen CCFv3 Z mm'].values, annotation=atlas.annotation, resolution=atlas.resolution)))
